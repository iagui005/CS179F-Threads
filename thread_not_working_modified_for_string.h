...
class Thread {
  ...
  static void* start( Thread*, vector<string> command_line );
  virtual void action(vector<string> tok);
  Semaphore go;
...
void* Thread::start(Thread* myself, vector<string> command_line) {                     // static.
